...
<!-- Page Banner Start -->
<section class="page-banner py-80">
    <div class="container-fluid">
        <div class="text-center mb-64">
            <h2 class="fw-700 color-primary mb-16">Coffee <span class="color-ter">Purchase Cart</span></h2>
        </div>
    </div>

    <!-- Customer Container Start -->
    <div class="customer-container py-40 mt-4">
        <div class="container-fluid">
