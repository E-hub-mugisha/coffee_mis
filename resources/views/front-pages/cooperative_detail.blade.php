                                        ...
                                        <div class="product-slider-asnav slick-initialized slick-slider">
                                            <div class="slick-list draggable">
                                                <div class="slick-track" style="opacity: 1; width: 20000px; transform: translate3d(0px, 0px, 0px);">
                                                    <div class="nav-image slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0">
                                                        <img src="assets/media/images/product-asnav-1.png" alt="">
                                                    </div>
                                                    <div class="nav-image slick-slide slick-active" data-slick-index="1" aria-hidden="false" tabindex="0">
                                                        <img src="assets/media/images/product-asnav-2.png" alt="">
                                                    </div>
                                                    <div class="nav-image slick-slide slick-active" data-slick-index="2" aria-hidden="false" tabindex="0">
                                                        <img src="assets/media/images/product-asnav-3.png" alt="">
                                                    </div>
                                                    <div class="nav-image slick-slide slick-active" data-slick-index="3" aria-hidden="false" tabindex="0">
                                                        <img src="assets/media/images/product-asnav-4.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="slick-list draggable">
                                                <div class="slick-track" style="opacity: 1; width: 3144px;">
                                                    <div class="detail-image slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0" style="width: 786px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
                                                        <img src="assets/media/images/product-detail-1.png" alt="">
                                                    </div>
                                                    <div class="detail-image slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" style="width: 786px; position: relative; left: -786px; top: 0px; z-index: 998; opacity: 0;">
                                                        <img src="assets/media/images/product-detail-2.png" alt="">
                                                    </div>
                                                    <div class="detail-image slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" style="width: 786px; position: relative; left: -1572px; top: 0px; z-index: 998; opacity: 0;">
                                                        <img src="assets/media/images/product-detail-3.png" alt="">
                                                    </div>
                                                    <div class="detail-image slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 786px; position: relative; left: -2358px; top: 0px; z-index: 998; opacity: 0;">
                                                        <img src="assets/media/images/product-detail-4.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#" class="social-links">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                                <g clip-path="url(#clip0_43576_866)">
                                                    <path d="M12.416 4.0332C12.6748 4.0332 12.8848 3.8232 12.8848 3.56445V0.751953C12.8848 0.493203 12.6748 0.283203 12.416 0.283203H9.60352C7.79414 0.283203 6.32227 1.75508 6.32227 3.56445V5.9082H4.91602C4.65727 5.9082 4.44727 6.1182 4.44727 6.37695V9.18945C4.44727 9.4482 4.65727 9.6582 4.91602 9.6582H6.32227V15.8145C6.32227 16.0732 6.53227 16.2832 6.79102 16.2832H9.60352C9.86227 16.2832 10.0723 16.0732 10.0723 15.8145V9.6582H11.9473C12.1763 9.6582 12.372 9.49258 12.4098 9.26664L12.8785 6.45414C12.901 6.3182 12.8629 6.17914 12.7738 6.07383C12.6848 5.96883 12.5538 5.9082 12.416 5.9082H10.0723V4.0332H12.416ZM9.60352 6.8457H11.8626L11.5501 8.7207H9.60352C9.34477 8.7207 9.13477 8.9307 9.13477 9.18945V15.3457H7.25977V9.18945C7.25977 8.9307 7.04977 8.7207 6.79102 8.7207H5.38477V6.8457H6.79102C7.04977 6.8457 7.25977 6.6357 7.25977 6.37695V3.56445C7.25977 2.27227 8.31133 1.2207 9.60352 1.2207H11.9473V3.0957H9.60352C9.34477 3.0957 9.13477 3.3057 9.13477 3.56445V6.37695C9.13477 6.6357 9.34477 6.8457 9.60352 6.8457Z" fill="#ECD6D0"></path>
                                                </g>
                                                <defs>
                                                    <clipPath>
                                                        <rect width="16" height="16" fill="white" transform="translate(0.666016 0.283203)"></rect>
                                                    </clipPath>
                                                </defs>
                                            </svg>
                                        </a>
                                        ...
                                        <a href="#" class="social-links">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                                <g clip-path="url(#clip0_43576_870)">
                                                    <path d="M10.1612 7.05811L15.9895 0.283203H14.6083L9.54764 6.16576L5.50568 0.283203H0.84375L6.95599 9.17867L0.84375 16.2832H2.22494L7.56917 10.071L11.8378 16.2832H16.4997L10.1608 7.05811H10.1612ZM8.26944 9.25704L7.65014 8.37125L2.72261 1.32294H4.84404L8.82062 7.01116L9.43992 7.89694L14.609 15.2907H12.4876L8.26944 9.25738V9.25704Z" fill="#ECD6D0"></path>
                                                </g>
                                                <defs>
                                                    <clipPath>
                                                        <rect width="16" height="16" fill="white" transform="translate(0.666016 0.283203)"></rect>
